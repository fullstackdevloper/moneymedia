			...
			<div class="row-fluid">
				<div class="span4">
					<div class="mu-box serv-box">
						<h3><a href="<?php echo $base_url;?>/User/userlist">Manage Users</a></h3>
					</div>
				</div>
				<div class="span4">
					<div class="bcf-box serv-box">
						<h3><a href="<?php echo $base_url;?>/Package/packagelist">Packages</a></h3>
					</div>
				</div>
				<div class="span4">
					<div class="bm-box serv-box">
						<h3><a href="<?php echo $base_url;?>/Admin/orders">Orders</a></h3>
					</div>
				</div>				
			</div>		 
         <!-- END PAGE CONTAINER-->    
