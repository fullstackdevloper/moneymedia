   ...
   <body>
      ...
      <header>
         <div class="container">
               ...
               <div class="col-xs-12 col-sm-2 logo"> <a href="<?php echo $base_url;?>"><img src="<?php echo $base_url;?>/images/logo-n.png" alt="Money Media Solution"></a> <!--<button type="button" class="navbar-toggle " data-toggle="collapse" data-target="#bs-example-navbar-collapse-2" aria-expanded="false"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button> --></div>
...
<h4>When Developers Compete, You Win!</h4>               
       </div>
