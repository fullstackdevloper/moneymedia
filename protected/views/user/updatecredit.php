                  ...
                  <input class="span9" id="id" name="id" type="hidden" value="<?php echo $userdata; ?>"/>
                    ...
                    <div class="span6">
                        ...
                        <div class="control-group">
                          ...
                          <label class="control-label">Pending credits added by admin:</label>

                          <div class="controls">
							<?php echo $click_no['clicks']; ?>      
                          </div>
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            ...
                            <input type="number" name="clicks" placeholder="Credit" min="0" class="m-wrap span12"  required value="" />
